...
// Simplified event names that match the backend EventEmitter2 structure
// These events are directly forwarded from managers without re-emission
export const MANAGER_EVENTS = {
  // Context Manager Events (forwarded directly from ContextManager)
  CONTEXT: {
    CREATED: "context:created",
    UPDATED: "context:updated",
    DELETED: "context:deleted",
    URL_CHANGED: "context:url:changed",
    LOCKED: "context:locked",
    UNLOCKED: "context:unlocked"
  },

  // Document Events (forwarded from Context instances)
  DOCUMENT: {
  ...
  // Workspace Events (forwarded from WorkspaceManager and Workspace instances)
  WORKSPACE: {
    CREATED: "workspace:created",
    UPDATED: "workspace:updated",
    DELETED: "workspace:deleted",
    DOCUMENT_INSERTED: "workspace:document:inserted",
    DOCUMENT_UPDATED: "workspace:document:updated",
    DOCUMENT_REMOVED: "workspace:document:removed",
    DOCUMENT_DELETED: "workspace:document:deleted",
    TREE_DOCUMENT_INSERTED: "workspace:tree:document:inserted",
    TREE_DOCUMENT_UPDATED: "workspace:tree:document:updated",
    TREE_DOCUMENT_REMOVED: "workspace:tree:document:removed",
    TREE_DOCUMENT_DELETED: "workspace:tree:document:deleted"
  },

  // Context-Workspace Bridge Events (forwarded from Context instances when workspace events are relevant)
  CONTEXT_WORKSPACE: {
    DOCUMENT_INSERTED: "context:workspace:document:inserted",
    DOCUMENT_UPDATED: "context:workspace:document:updated",
    DOCUMENT_REMOVED: "context:workspace:document:removed",
    DOCUMENT_DELETED: "context:workspace:document:deleted",
    TREE_DOCUMENT_INSERTED: "context:workspace:tree:document:inserted",
    TREE_DOCUMENT_UPDATED: "context:workspace:tree:document:updated",
    TREE_DOCUMENT_REMOVED: "context:workspace:tree:document:removed",
    TREE_DOCUMENT_DELETED: "context:workspace:tree:document:deleted"
  }
}

// Legacy socket messages for backward compatibility
// TODO: Migrate to MANAGER_EVENTS over time
